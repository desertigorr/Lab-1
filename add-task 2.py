...
with open('books.csv', 'r', encoding='cp1251') as f:
    ...
    # Сортируем массив
    # Примечание: books_list представляет собой массив, состоящий из кортежей
    # Первый элемент каждого кортежа - популярность книги (число), что делает возможным сортировку такой конструкции
